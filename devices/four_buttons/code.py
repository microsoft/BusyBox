...
while True:
    ...
    # Scale the potentiometer value to fit the 0-1 range
    scaled_value1 = (pot_value1 - 0.3) / (3.0)
    scaled_value2 = (pot_value2 - 0.3) / (2.7)

    # Print the potentiometer value and RGB values for debugging
    print(
        f"SLIDER1: {pot_value1:.2f} V, Scaled Value: {scaled_value1:.2f}, SLIDER2: {pot_value2:.2f} V, Scaled Value: {scaled_value2:.2f}"
    )
